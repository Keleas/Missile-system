    ...
    ui(new Ui::modeling)
{
    ...
    ui->customPlot_2->xAxis->setRange(0, 10000);
    ui->customPlot_2->yAxis->setRange(0, 10000);
    //ui->customPlot_2->
...
//    ui->customPlot_1->plotLayout()->addElement(0, 0, title);
    ...
    ui->customPlot_1->xAxis->setLabel("Высота, км");
    ui->customPlot_1->yAxis->setLabel("Горизонтальная дальность, км");
